...
public class DeviceAdmin_Page {

	AppiumDriver driver;

	public DeviceAdmin_Page(AppiumDriver driver) {
	...
	public void DeviceAdminClick() throws InterruptedException {
		device_admin.click();
		Thread.sleep(2000);
	}

	public void GeneralClick() throws InterruptedException {
		general.click();
		Thread.sleep(2000);
	}
